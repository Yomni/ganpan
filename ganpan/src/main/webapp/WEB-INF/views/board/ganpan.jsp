...
<script
	src="${pageContext.request.contextPath}/resources/js/jquery.sortable.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/jquery-ui.min.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/dist/css/droppable.css" />
							...
							<td><c:if
								...
								<ul class="list-unstyled ui-widget-header ui-widget-content"
									...
									<c:forEach items="${boardList.works}" var="works">
										...
										<div class="modal fade" id="${works.workNo}modal"
